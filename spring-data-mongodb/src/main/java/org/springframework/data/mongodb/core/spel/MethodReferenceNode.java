...
public class MethodReferenceNode extends ExpressionNode {
	...
	static {
		...
		map.put("setDifference", "$setDifference"); // Returns a set with elements that appear in the 1st set but not in the 2nd.
		...
		// two values are numbers, return the difference. If the two values are dates, return the difference in milliseconds.
		...
		// seconds.
		map.put("millisecond", "$millisecond"); // Returns the millisecond portion of a date as an integer between 0 and 999.
