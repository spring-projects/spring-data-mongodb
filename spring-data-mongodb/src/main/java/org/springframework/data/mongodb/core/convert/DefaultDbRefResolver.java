...
public class DefaultDbRefResolver implements DbRefResolver {
	...
	private static class ObjenesisProxyEnhancer {
		 ...
		 * @author Thomas Darimont
		 */
		static class DefaultObjenesisInstanceCreatorStrategy implements InstanceCreatorStrategy {
		 ...
		 * @author Thomas Darimont
		 */
		static class Spring4ObjenesisInstanceCreatorStrategy implements InstanceCreatorStrategy {
