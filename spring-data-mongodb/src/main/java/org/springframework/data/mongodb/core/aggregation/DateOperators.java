...
public class DateOperators {
	...
	public static abstract class TimezonedDateAggregationExpression extends AbstractAggregationExpression {
		...
		protected static java.util.Map<String, Object> appendTimezone(Object source, Timezone timezone) {
			...
			if (source instanceof Map) {
				args = new LinkedHashMap<String, Object>((Map) source);
			} else {
	 ...
	 * @since 2.1
	 */
	public static abstract class DateParts<T extends DateParts<T>> extends TimezonedDateAggregationExpression {
		 ...
		 */
		public abstract T minute(Object minute);
		 ...
		 */
		public abstract T second(Object second);
		 ...
		 */
		public abstract T milliseconds(Object milliseconds);
	 ...
	 * @since 2.1
	 */
	public static class DateFromParts extends DateParts<DateFromParts> {
		...
		public static abstract class DateFromPartsWithYear {
			 ...
			 * @throws IllegalArgumentException if given {@literal year} is {@literal null}
			 */
			public abstract DateFromParts year(Object year);
	 ...
	 * @since 2.1
	 */
	public static class IsoDateFromParts extends DateParts<IsoDateFromParts> {
		...
		public static abstract class IsoDateFromPartsWithYear {
			 ...
			 * @throws IllegalArgumentException if given {@literal isoWeekYear} is {@literal null}.
			 */
			public abstract IsoDateFromParts isoWeekYear(Object isoWeekYear);
