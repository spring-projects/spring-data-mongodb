...
import org.springframework.data.mongodb.mapping.BasicMongoPersistentProperty;
...
public class BasicMongoPersistentPropertyUnitTests {
	...
	class Person {
		...
		@org.springframework.data.mongodb.mapping.Field("foo")
		String firstname;
		String lastname;
		
		@org.springframework.data.mongodb.mapping.Field(order = -20)
		String ssn;
	}
}
